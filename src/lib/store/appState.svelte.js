...
class AppState {
  ...
  // символы введённые пользователем в режиме дробей. Необходимы для правильной расстановки маркеров отвечающих за смешанные дроби и дроби со сложными выражениями в числителе и/или знаменателе.
  /** @type {string} */
